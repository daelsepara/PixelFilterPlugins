...
extern "C"
{
	...
	const int FilterID = 0x5D1D;
	const char* FilterName = "LQ 2XN";
	const char* FilterDescription = "LQ 2XN Family of Filters";
				...
				for (auto x = 0; x < srcx; x++)
				{
					...
					switch(scale)
					{
						...
						case 3: // 2x3
							...
							Lq2x3Kernel(pattern, c0, c1, c2, c3, c4, c5, c6, c7, c8, P);
